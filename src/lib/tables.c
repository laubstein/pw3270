/*
 * Modifications Copyright 1993, 1994, 1995, 1999, 2001 by Paul Mattes.
...
unsigned char ebc2cg[256] = { EBC2CG };
unsigned char ebc2cg0[256] = { EBC2CG };
#define CG2EBC \
...
unsigned char cg2ebc[256] = { CG2EBC };
unsigned char cg2ebc0[256] = { CG2EBC };
#define EBC2ASC \
...
unsigned char ebc2asc[256] = { EBC2ASC };
unsigned char ebc2asc0[256] = { EBC2ASC };
#define EBC2ASC7 \
/*00*/  0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, \
/*08*/  0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, \
/*10*/  0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, \
...
unsigned char ebc2asc7[256] = { EBC2ASC7 };
unsigned char ebc2asc70[256] = { EBC2ASC7 };
#define ASC2EBC \
/*00*/  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
/*08*/  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
/*10*/  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, \
...
unsigned char asc2ebc[256] = { ASC2EBC };
unsigned char asc2ebc0[256] = { ASC2EBC };
#if defined(X3270_DISPLAY) /*[*/
unsigned char cg2uc[256] = {
...
unsigned char ft2asc[256] = { FT2ASC };
unsigned char ft2asc0[256] = { FT2ASC };
#define ASC2FT \
0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0a,0x0b,0x0c,0x0d,0x0e,0x0f, \
0x10,0x11,0x12,0x13,0x14,0x15,0x16,0x17,0x18,0x19,0x1a,0x1b,0x1c,0x1d,0x1e,0x1f, \
0x20,0x21,0x22,0x23,0x24,0x25,0x26,0x27,0x28,0x29,0x2a,0x2b,0x2c,0x2d,0x2e,0x2f, \
