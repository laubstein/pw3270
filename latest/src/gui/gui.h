 ...
 */
	...
	#define TERMINAL_COLOR_OIA_SCRIPT_STATE		TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_OIA_SSL_STATE		TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_OIA_SHIFT_STATE		TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_OIA_INSERT_STATE		TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_OIA_ALT_STATE		TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_OIA_TYPEAHEAD_STATE	TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_OIA_TIMER			TERMINAL_COLOR_OIA_STATUS_OK
