 ...
 */
	...
	#define TERMINAL_COLOR_SSL_STATE			TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_SHIFT_STATE			TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_ALT_STATE			TERMINAL_COLOR_OIA
	#define TERMINAL_COLOR_TYPEAHEAD_STATE		TERMINAL_COLOR_OIA
